...
## Phase 4: Execute - Restructure Directories
**Goal:** Add references/ folders to all skills  
**Status:** Pending

## Phase 5: Execute - Update SKILL.md Files
**Goal:** Remove Claude-specific frontmatter, update content  
**Status:** Pending

## Phase 6: Execute - Migrate Canonical Contracts
**Goal:** Move workflow content to references/ folders  
**Status:** Pending

## Phase 7: Execute - Update Tests
