---
name: pre-commit
description: Run pre-commit readiness checks and summarize blockers before committing. Use when the user asks "ready to commit", "pre-commit check", "can I commit", or "validate changes" before committing code.
---
